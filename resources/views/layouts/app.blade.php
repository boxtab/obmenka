...
<head>
    ...
    <title>@guest(){{config('app.name')}}@else{{ $titlePage . ' - ' . config('app.name')}}@endguest</title>
    ...
    <link href="{{ asset('css/common-form.css') }}?v=@version" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('css/common-list.css') }}?v=@version" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('css/custom.css') }}?v=@version" rel="stylesheet"/>
    <link href="{{ asset('css/sidebar.css') }}?v=@version" rel="stylesheet"/>
    ...
    <div class="fixed-plugin d-none">
        <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <!-- Trash... -->
                <li class="button-container d-none">
                ...
                <li class="button-container github-star d-none">
                    <a class="github-button" href="https://github.com/creativetimofficial/material-dashboard-laravel"
                       data-icon="octicon-star" data-size="large" data-show-count="true"
                       aria-label="Star ntkme/github-buttons on GitHub">Star</a>
                </li>
                <li class="header-title d-none">Thank you for 95 shares!</li>
                <li class="button-container text-center d-none">
...
<script src="{{ asset('js/calc.js') }}?v=@version"></script>
<script src="{{ asset('js/show-message.js') }}?v=@version"></script>
<script src="{{ asset('js/processing-message.js') }}?v=@version"></script>
<script src="{{ asset('js/digital-input-filter.js') }}?v=@version"></script>
