@extends('layouts.app', ['activePage' => 'role', 'titlePage' => 'Роли: Добавление/Редактирование'])
                        ...
                        <div class="card ">
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <div class="col-lg-6 text-left">
                                    <button type="submit" form="form-role" class="btn btn-primary">Сохранить</button>
                                </div>
                                <div class="col-lg-6 text-right">
                                    <a href="{{ route('role.index') }}" class="btn btn-block" role="button">Назад</a>
                                </div>
                            </div>
                        </div>
                    </form>
