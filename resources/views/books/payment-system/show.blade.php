@extends('layouts.app', ['activePage' => 'payment-system', 'titlePage' => 'Справочник платежных систем: Добавление/Редактирование'])
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post"
                          action="{{ route('payment-system.store') }}"
                          autocomplete="off"
                          id="form-payment-system"
                        ...
                        <div class="card ">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input
                                                ...
                                                type="text"
                                                disabled
                                                value="{{ $paymentSystem->created_at ?? '' }}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input
                                                ...
                                                type="text"
                                                disabled
                                                value="{{ $paymentSystem->updated_at ?? '' }}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer ml-auto mr-auto">
                                <div class="col-lg-6 text-left">
                                    <button type="submit" form="form-payment-system" class="btn btn-primary">Сохранить</button>
                                </div>
                                <div class="col-lg-6 text-right">
                                    <a href="{{ route('payment-system.index') }}" class="btn btn-block" role="button">Назад</a>
                                </div>
                            </div>
                        </div>
                    </form>
